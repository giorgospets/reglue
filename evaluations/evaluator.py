...
def main():
    ...
    parser.add_argument("--vae_cfg",  choices=['true', 'false'], default='false')
    parser.add_argument("--gh", default=1.0, type=float)
    parser.add_argument("--gl", default=0.0, type=float)
    ...
    if args.cfg_cond:
        file_path = args.save_path + str(args.num_steps) + str(args.step) + str(args.cfg) + str(args.gh) + str(args.gl) +str(args.cls_cfg)+ "-vae_cfg-"+ args.vae_cfg +"-cfg_cond_true.txt"
    else:
        file_path = args.save_path + str(args.num_steps) + str(args.step) + str(args.cfg) + str(args.gh) + str(args.gl)+ str(args.cls_cfg)+ "-vae_cfg-"+ args.vae_cfg +"-cfg_cond_false.txt"
