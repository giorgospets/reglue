...
class SILoss:
    ...
    def __call__(self, model, images, model_kwargs=None, zs=None, cls_token=None,
        ...
        #denoising_loss
        denoising_loss = mean_flat((model_output[:,:4,:,:] - model_target[:,:4,:,:]) ** 2)
        dino_loss = mean_flat((model_output[:,4:,:,:] - model_target[:,4:,:,:]) ** 2)
        ...
        return denoising_loss, dino_loss, proj_loss, time_input, noises, denoising_loss_cls
